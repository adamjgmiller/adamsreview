...
2. Detection fan-out: launch all applicable lenses as one parallel batch.
...
5. Dedup and score.
6. Validation fan-out: deep findings one-per-agent, light findings in chunks of at most 25.
...
4. Launch one worker per fix group as one parallel batch.
