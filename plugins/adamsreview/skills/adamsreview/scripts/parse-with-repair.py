...
Use cases:
- Phase 1 lens outputs, Phase 4 validator outputs, Phase 1.5 external enrichment
...
fragments/02-external enrichment-adapter.md. See project instruction files Helper index entry.
"""
