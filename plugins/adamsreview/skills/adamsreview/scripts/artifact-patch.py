...
def cmd_apply_decisions(args):
    ...
    #     single batched Opus call (re-dispatch one sub-agent per candidate);
    ...
    if args.expected > 0 and len(decisions) != args.expected:
        ...
        c.err_prompt(
            ...
            action=(
                ...
                "Opus call (re-dispatch one sub-agent per candidate and recompose "
...
def _trace_path_for(args):
    ...
    --path as absolute, per project instruction files rule 11.
    """
